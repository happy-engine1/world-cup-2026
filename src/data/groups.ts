...
// （2026-06-27 時点の実データ: A〜I が3試合消化済み、残りJ・K・Lは2試合）
export const FINAL_GROUPS = new Set<GroupLetter>(["A", "B", "C", "D", "E", "F", "G", "H", "I"]);
...
const RAW: Record<GroupLetter, Stat[]> = {
  ...
  G: [
    r("eg", "エジプト", 3, 1, 2, 0, 5, 3, -5),
    r("be", "ベルギー", 3, 1, 2, 0, 2, 1, -7),
    r("ir", "イラン", 3, 0, 3, 0, 3, 3, -4),
    r("nz", "ニュージーランド", 3, 0, 1, 2, 3, 6, -2),
  ],
  // --- 途中グループ（2試合終了）---
  J: [
