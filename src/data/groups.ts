...
const RAW: Record<GroupLetter, Stat[]> = {
  ...
  // --- 途中グループ（2試合終了）---
  D: [
    r("us", "アメリカ", 2, 2, 0, 0, 6, 1, -4),
    r("au", "オーストラリア", 2, 1, 0, 1, 2, 2, -4),
    r("py", "パラグアイ", 2, 1, 0, 1, 2, 4, -11),
    r("tr", "トルコ", 2, 0, 0, 2, 0, 3, -3),
  ],
  E: [
    r("de", "ドイツ", 2, 2, 0, 0, 9, 2, 0),
    r("ci", "コートジボワール", 2, 1, 0, 1, 2, 2, -3),
    r("ec", "エクアドル", 2, 0, 1, 1, 0, 1, -2),
    r("cw", "キュラソー", 2, 0, 1, 1, 1, 7, -5),
  ],
  F: [
    r("nl", "オランダ", 2, 1, 1, 0, 7, 3, -3),
    r("jp", "日本", 2, 1, 1, 0, 6, 2, 0),
    r("se", "スウェーデン", 2, 1, 0, 1, 6, 6, -3),
    r("tn", "チュニジア", 2, 0, 0, 2, 1, 9, -1),
  ],
  G: [
    r("eg", "エジプト", 2, 1, 1, 0, 4, 2, -3),
    r("ir", "イラン", 2, 0, 2, 0, 2, 2, -2),
    r("be", "ベルギー", 2, 0, 2, 0, 1, 1, -7),
    r("nz", "ニュージーランド", 2, 0, 1, 1, 3, 5, -2),
  ],
  H: [
    r("es", "スペイン", 2, 1, 1, 0, 4, 0, -1),
    r("uy", "ウルグアイ", 2, 0, 2, 0, 3, 3, -2),
    r("cv", "カーボベルデ", 2, 0, 2, 0, 2, 2, -3),
    r("sa", "サウジアラビア", 2, 0, 1, 1, 1, 5, -3),
  ],
  I: [
    r("fr", "フランス", 2, 2, 0, 0, 6, 1, 0),
    r("no", "ノルウェー", 2, 2, 0, 0, 7, 3, 0),
    r("sn", "セネガル", 2, 0, 0, 2, 3, 6, 0),
    r("iq", "イラク", 2, 0, 0, 2, 1, 7, -2),
  ],
  J: [
    r("ar", "アルゼンチン", 2, 2, 0, 0, 5, 0, -2),
    r("at", "オーストリア", 2, 1, 0, 1, 3, 3, -3),
    r("dz", "アルジェリア", 2, 1, 0, 1, 2, 4, -1),
    r("jo", "ヨルダン", 2, 0, 0, 2, 2, 5, -1),
  ],
  K: [
    r("co", "コロンビア", 2, 2, 0, 0, 4, 1, -3),
    r("pt", "ポルトガル", 2, 1, 1, 0, 6, 1, -4),
    r("cd", "コンゴ民主共和国", 2, 0, 1, 1, 1, 2, -2),
    r("uz", "ウズベキスタン", 2, 0, 0, 2, 1, 8, -2),
  ],
  L: [
    r("gb-eng", "イングランド", 2, 1, 1, 0, 4, 2, -1),
    r("gh", "ガーナ", 2, 1, 1, 0, 1, 0, -2),
    r("hr", "クロアチア", 2, 1, 0, 1, 3, 4, -1),
    r("pa", "パナマ", 2, 0, 0, 2, 0, 2, -3),
  ],
};
